...
<!--Album-->
      <?php
				$query = "SELECT * FROM album WHERE AlbumID=2";
    ...
    <div class="div1" style="background-color: darkgrey">
        ...
        <h3><b>Total: $<?php echo $row["Price"]; ?></b></h3><br><br>
        
    <div class="md-modal md-effect-3" id="modal-3">
			<div class="md-content">
				<h3>Buy Item <button class="md-close" style="float:right;border-radius: 10%;width:auto;height:auto"><span class="glyphicon glyphicon-remove" ></span></button><br><br></h3>
				<div>
                    <div class = "div2"><?php echo $row["Title"]; ?> has been added to your basket.</div><br><br>
                    <img src="ProjectImage/<?php echo $row["CoverImage"]; ?>" width="180px" height="180px" style="float:left; margin-right: 90px">
                     <p style="color:black;font-size:20px;"><b>
                         <?php echo $row["Title"]; ?><br>
                        $<?php echo $row["Price"]; ?><br>
                    </b></p><br><br><br><br><br><br>
                    <a href="payment_details.php"><button>Proceed  <span class="glyphicon glyphicon-chevron-right" ></span></button></a>
				</div>
			</div>
		</div>
    
    <button id="but" data-modal="modal-3" class="md-trigger" style="color:black">Buy now  <span class="glyphicon glyphicon-chevron-right" ></span></button>
    ...
    <button class="button button4">Add to cart  <span class="glyphicon glyphicon-chevron-right" ></span></button>
