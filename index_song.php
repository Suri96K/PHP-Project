...
<input type="submit"  class="button_text" type="submit" name="add" value="Add +"  onclick="window.location='ad_song.php';"/><br><br>
...
//echo '<img src="your_path_to_image/'.$image.'" />';		
		...
		echo "<td><a class=one href=\"edit_song.php?SongID=$row[SongID]\">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<a class=one href=\"delete_song.php?SongID=$row[SongID]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
