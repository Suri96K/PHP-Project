...
<a href  ="logout.php"><button class="button_text"><span class="glyphicon glyphicon-user"></span>Welcome Admin!Logout</button>
<div class="sidebar">
  <a class="active" href="index_song.php">Manage Songs</a>
  <a href="index_album.php">Manage Albums</a>
  <a href="index_genre.php">Manage Genres</a>
   <a href="delete_userss.php">Delete users</a>  
...
//echo '<img src="your_path_to_image/'.$image.'" />';		
		...
		echo "<td><a class=one href=\"enable_user.php?UserID=$row[UserID]\"onClick=\"return confirm('Are you sure you want to activate account?')\">Enable</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<a class=one href=\"disable_user.php?UserID=$row[UserID]\" onClick=\"return confirm('Are you sure you want to deactivate account?')\">Disable</a></td>";		
...
//echo '<img src="your_path_to_image/'.$image.'" />';		
		...
		echo "<td><a class=one href=\"enable_user.php?UserID=$row[UserID]\">Enable</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<a class=one href=\"disable_user.php?UserID=$row[UserID]\" onClick=\"return confirm('Are you sure you want to deactivate acccunt?')\">Disable</a></td>";		
