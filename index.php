...
<div class="top-container">
   ...
   <a href="multireg.php"> <button class="button button4"><span class="glyphicon glyphicon-plus-sign" ></span>  Create new account</button></a>
    
   <a href="login.php" ><button class="button button4"><span class="glyphicon glyphicon-user" ></span>  Login</button></a>
...
<form class="example" action="/action_page.php" style="margin:auto;max-width:800px">
  ...
  <a href="search.php"><button type="submit"></button></a>
</form>
...
<div class="img">
   ...
   <a href="veiw_more.php"> <button class="button10 button11">View more  <span class="glyphicon glyphicon-chevron-right" ></a></span></button><br><br><br>
...
<br><br>
    ...
    <a href="veiw_more1.php"><button class="button10 button11">View more  <span class="glyphicon glyphicon-chevron-right" ></a></span></button><br><br><br>
