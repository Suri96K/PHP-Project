  ...
  <div class="col-50">
    <div class="container" style="margin-left:30%;margin-right:30%;background-color:black">
        <div class="row">
          ...
          <div class="col-50">
              <h2><span style="color:white">Add Album Details</span></h2>
		

    <!--------input details of song-------->		
	<form id="form1" name="form1" action = "add_album_q.php" method="POST" enctype="multipart/form-data">
    ...
    <?php while($row = $result->fetch_assoc()) {?>
    	<option value="<?php echo $row['GenreID']?>"><?php echo $row['Type']?></option>
    ...
    <br /><br>
     ...
     <input type="number" step="00.01" id="Price" name="Price" placeholder="$0.00" required="required">
    
	 <label for="DateReleased">Date Released</label>
     <input type="text" id="date" name="DateReleased" placeholder="yy-mm-dd" required="required">
...
<br><br><br><br>
    ...
    <label for="Description">Album Description</label>
	     <input type="text" id="Description" name="Description" placeholder="Album Description...." required=="required" maxlength="500">
